...
class MatBao(object):
    ...
    def get_dict(self):
        dic = to_dict(self.source, self.get_vn(), self.get_com(), self.get_com_vn(), self.get_net(), self.get_org(), self.get_info())
...
def crawl(*args):
    for x in args:
        x.get_dict()
    export_to_json(list_price, "/home/cuongnq/crawl/code_crawl/output.json")
