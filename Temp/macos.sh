...
upgrade(){
    ...
    sudo launchctl unload -w /Library/LaunchDaemons/bizfly.backup.plist
    sudo rm -Rf /etc/bizfly-backup /usr/local/bin/bizfly-backup /Library/LaunchDaemons/bizfly.backup.plist
    sudo rm -f /tmp/bizfly-backup.sock /tmp/bizfly-backup.stderr /tmp/bizfly-backup.stdout
    download_agent
